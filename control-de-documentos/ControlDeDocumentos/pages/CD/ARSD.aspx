<%@ Page Title="Administrar Requerimiento SubDirector" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Site.Master" CodeBehind="ARSD.aspx.vb" Inherits="ControlDeDocumentos.ARSD" %>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Administrar Requerimiento</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-orange card-outline">
            <div class="card-header">
              <h3 class="card-title">
                <i class="nav-icon fas fa-file-alt text-orange m-2"></i>Administrar Requerimiento
              </h3>
            </div>
            <div class="card-body">
              <!-- TAB HEADER -->
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12 mb-2 text-center">
                        <div class="form-group">
                          <div class="custom-control custom-switch">
                            <input type="checkbox" id="actividades" onclick="isChecked('MainContent_actividades', '0');" checked="checked" class="custom-control-input" runat="server">
                                  ...
                                  <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                      <div class="d-flex justify-content-center text-center">
                                        <asp:LinkButton ID="btnADView" ToolTip="Ver detalle" class="mx-2" runat="server" Style="color: #e83e8c"><i class="fas fa-eye"></i></asp:LinkButton>
                                        <asp:LinkButton ID="btnADAddUser" ToolTip="Asignar a Operador" class="mx-2" runat="server" Style="color: #03650b"><i class="fa fa-user-plus"></i></asp:LinkButton>
                                        <asp:LinkButton ID="btnADOutFile" ToolTip="Archivo de salida" class="mx-2" runat="server" Style="color: #dc3545"><i class="fas fa-reply"></i></asp:LinkButton>
                  ...
                  <div class="container-fluid">
                    <div class="row my-2">
                      <div class="col-sm-12 col-md-12 col-lg-12 mt-2">
                        <h3 id="actividadesTitulo" class="text-bold text-orange" runat="server">Actividades</h3>
                      </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Message" runat="server">
  ...
  <!-- ASIGNAR ACTIVIDADES -->
  <div class="modal fade" id="viewAddUser576" tabindex="-1" role="dialog" aria-labelledby="viewModalLabelAD" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Agregar usuario para el documento 
            <strong>
              <asp:Label ID="addUserModalADCorrelativoRemitente2" runat="server" />
            </strong>
          </h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 mt-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <textarea id="taADComment1" class="form-control" rows="4" placeholder="..." runat="server"></textarea>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer d-flex justify-content-between">
          ...
          <asp:LinkButton ID="btnADAsignar576" CssClass="btn btn-outline-success" runat="server"><i class="fas fa-plus"></i> Asignar</asp:LinkButton>
          <button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><i class="far fa-times-circle mr-2"></i>Cerrar</button>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal-upload-file" tabindex="-1" role="dialog" aria-labelledby="modal-upload-file-label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 831px;" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Información del documento 
            <strong>
              <asp:Label ID="uploadFileModalCorrelativoRemitente" runat="server" />
            </strong>
          </h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
              <div class="form-group">
                <label>Estatus</label>
                <select id="estatusSalida" class="form-control select2" style="width: 100%;" runat="server">
                  <option value="0" selected="selected">Sin información</option>
                </select>
              </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
              <div class="form-group">
                <label>Sub Estatus</label>
                <select id="subEstatusSalida" class="form-control select2" style="width: 100%;" runat="server">
                  <option value="0" selected="selected">Sin información</option>
                </select>
              </div>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Script" runat="server">
  <script type="text/javascript">
    $(function () {
      ...
      $('#Message_taADComment1').summernote({
        placeholder: 'Descripción breve y consisa del documento.',
        width: '100%',
        height: 150,
        toolbar: [
