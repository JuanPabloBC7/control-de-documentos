<%@ Page Title="Administrar Actividades Operador" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Site.Master" CodeBehind="ARO.aspx.vb" Inherits="ControlDeDocumentos.ARO" %>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-danger card-outline">
            <div class="card-header">
              <h3 class="card-title">
                <i class="nav-icon fas fa-cogs text-danger m-2"></i>Administrar Actividades
              </h3>
            </div>
            <div class="card-body">
              <!-- TAB HEADER -->
                            ...
                            <ContentTemplate>
                              <asp:GridView 
                                ...
                                <Columns>
                                  ...
                                  <asp:BoundField DataField="SUBST_DOCTO" HeaderText="Estatus" />
                  ...
                  <div class="container-fluid">
                    <div class="row my-2">
                      <div class="col-sm-12 col-md-12 col-lg-12 mt-2">
                        <h3 id="actividadesTitulo" class="text-bold text-danger" runat="server">Actividades</h3>
                      </div>
