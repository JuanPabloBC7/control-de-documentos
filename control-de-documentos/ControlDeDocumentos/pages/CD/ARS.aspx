<%@ Page Title="Administrar Documento Secretarial" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Site.Master" CodeBehind="ARS.aspx.vb" Inherits="ControlDeDocumentos.ARS" %>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Administrar Documento</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card card-pink card-outline">
            <div class="card-header">
              <h3 class="card-title">
                <i class="nav-icon fas fa-cogs text-pink m-2"></i>Administrar Documento
              </h3>
            </div>
            <div class="card-body">
              <!-- TAB HEADER -->
              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                <li id="manageDocumentsLi" onclick="tabs(1)" class="nav-item" runat="server">
                  <a class="nav-link active" id="manageDocumentsTab" data-toggle="pill" href="#manageDocuments" role="tab" aria-selected="true" runat="server">Administrar Documentos</a>
                </li>
                    ...
                    <div class="row my-4">
                      <div class="col-sm-12 col-md-6 col-lg-4 mb-2">
                        <div class="form-group">
                          ...
                          <select id="tipoDeDocumento" class="form-control select2" style="width: 100%;" runat="server">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12 mb-2 text-center">
                        <div class="form-group">
                          <div class="custom-control custom-switch">
                            <input type="checkbox" id="documentos" onclick="isChecked('MainContent_documentos', '');" checked="checked" class="custom-control-input" runat="server">
                            <label class="custom-control-label" onclick="isChecked('MainContent_documentos', '');" for="documentos">Filtrar por usuario</label>
                          </div>
                        </div>
                      </div>
                                  ...
                                  <asp:TemplateField HeaderText="Acciones">
                                    <ItemTemplate>
                                      <div class="d-flex justify-content-center text-center">
                                        ...
                                        <asp:LinkButton ID="btnADAddTask" ToolTip="Agregar actividad" class="mx-2" runat="server" Style="color: #17a2b8"><i class="fa fa-plus"></i></asp:LinkButton>
                                        <asp:LinkButton ID="btnADOutFile" ToolTip="Archivo de salida" class="mx-2" runat="server" Style="color: #3f6791"><i class="fas fa-upload"></i></asp:LinkButton>
                                      </div>
                                    </ItemTemplate>
                                  </asp:TemplateField>
                                </Columns>
                  ...
                  <div class="container-fluid">
                    <div class="row my-2">
                      <div class="col-sm-12 col-md-12 col-lg-12 mt-2">
                        <h3 id="actividadesTitulo" class="text-bold text-pink" runat="server">Actividades</h3>
                      </div>
