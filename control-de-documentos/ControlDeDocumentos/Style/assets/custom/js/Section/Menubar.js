      ...
      value: function setupMenu() {
        if (typeof _jquery2.default.fn.mmenu !== 'undefined') {
          this.$el.mmenu({
            ...
            navbars: [{
              position: 'bottom',
              content: ['<div class="site-menubar-footer">\n              <a href="javascript: void(0);" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Ajustes">\n                <span class="icon wb-settings" aria-hidden="true"></span>\n              </a>\n              <a href="javascript: void(0);" data-placement="top" data-toggle="tooltip" data-original-title="Perfil">\n                <span class="icon wb-user" aria-hidden="true"></span>\n              </a>\n              <a href="/Vista/Login/frmLogin.aspx" data-placement="top" data-toggle="tooltip" data-original-title="Cerrar Sesi&oacute;n">\n                <span class="icon wb-power" aria-hidden="true"></span>\n              </a>\n            </div>']
            }]
          });
        }
      }
